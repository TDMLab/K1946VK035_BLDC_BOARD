...
//PLLCLK = REFSRC * (M/N) * (1/(2^OD))
    ...
    RCU->PLLDIV_bit.DIVEN = 1;
    RCU->PLLDIV_bit.DIV   = 2;
    while (!RCU->SYSCLKSTAT_bit.PLLDIVCLKGOOD);
...
void PeripheralClockEnable(){
	...
	RCU->PCLKCFG = 0b0000111111111111;	// PWM, CAP, QEP, I2C �������

	// ������ ������
	RCU->HRSTCFG = 0b00000111;			// CAN, GPIOA, GPIOB
	RCU->PRSTCFG = 0b0000111111111111;	// PWM, CAP, QEP, I2C �������
}
